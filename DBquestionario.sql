...
ALTER ROLE postgres WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:luPQwcytBdY07pDe8m5J7Q==$kg9+CFnxrdm9+7wcC05l8LXcfBJtgZzzvczUL1DDzEU=:j5LwHOU7Fog+BzkbWVNpxVh13NfTSvO5vEzmP2bXshI=' VALID UNTIL 'infinity';
...
INSERT INTO "DBquestionario"."User" VALUES (1, 'admin', 'admin', 'stevanay@gmail.com', '2000-09-23');
INSERT INTO "DBquestionario"."User" VALUES (2, 'prova', 'prova', 'prova@gmail.com', '1999-09-09');
INSERT INTO "DBquestionario"."User" VALUES (3, 'fabio', 'fabio', 'fabio@mail.it', '2021-04-08');
INSERT INTO "DBquestionario"."User" VALUES (4, 'antonio', 'boh', 'antonio@lol.no', '1904-04-19');
INSERT INTO "DBquestionario"."User" VALUES (5, 'mario', 'mario', 'mario@hah.lol', '1935-04-10');
INSERT INTO "DBquestionario"."User" VALUES (6, 'pierpaolo', 'lalalala', 'prova@mail.ciao', '2000-10-10');
INSERT INTO "DBquestionario"."User" VALUES (7, 'awdawd', 'awdawd', 'awdawd@lol', '2000-09-23');
INSERT INTO "DBquestionario"."User" VALUES (8, 'lollll', 'qweasd', 'lol@lol.it', '2021-04-14');
...
SELECT pg_catalog.setval('"DBquestionario"."Utente_id_user_seq"', 8, true);
